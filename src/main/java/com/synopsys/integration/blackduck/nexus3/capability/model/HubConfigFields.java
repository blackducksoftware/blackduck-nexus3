...
public class HubConfigFields {
    ...
    public static final StringTextFormField hubUrlField = new StringTextFormField(HubConfigField.HUB_URL.getKey(), LABEL_HUB_SERVER_URL, DESCRIPTION_HUB_SERVER_URL, FormField.MANDATORY);
    public static final StringTextFormField usernameField = new StringTextFormField(HubConfigField.HUB_USERNAME.getKey(), LABEL_HUB_USERNAME, DESCRIPTION_HUB_USERNAME, FormField.MANDATORY);
    public static final PasswordFormField passwordField = new PasswordFormField(HubConfigField.HUB_PASSWORD.getKey(), LABEL_HUB_PASSWORD, DESCRIPTION_HUB_PASSWORD, FormField.MANDATORY);
    public static final StringTextFormField timeoutField = new StringTextFormField(HubConfigField.HUB_TIMEOUT.getKey(), LABEL_CONNECTION_TIMEOUT, DESCRIPTION_HUB_TIMEOUT, FormField.MANDATORY).withInitialValue(DEFAULT_HUB_TIMEOUT);
    public static final CheckboxFormField autoImportCert = new CheckboxFormField(HubConfigField.HUB_TRUST_CERT.getKey(), LABEL_IMPORT_HUB_SSL_CERTIFICATE, DESCRIPTION_HUB_IMPORT_CERT, FormField.OPTIONAL);

    public static final StringTextFormField proxyHostField = new StringTextFormField(HubConfigField.HUB_PROXY_HOST.getKey(), LABEL_PROXY_HOST, DESCRIPTION_PROXY_HOST, FormField.OPTIONAL);
    public static final StringTextFormField proxyPortField = new StringTextFormField(HubConfigField.HUB_PROXY_PORT.getKey(), LABEL_PROXY_PORT, DESCRIPTION_PROXY_PORT, FormField.OPTIONAL);
    public static final StringTextFormField proxyUsernameField = new StringTextFormField(HubConfigField.HUB_PROXY_USERNAME.getKey(), LABEL_PROXY_USERNAME, DESCRIPTION_PROXY_USERNAME, FormField.OPTIONAL);
    public static final PasswordFormField proxyPasswordField = new PasswordFormField(HubConfigField.HUB_PROXY_PASSWORD.getKey(), LABEL_PROXY_PASSWORD, DESCRIPTION_PROXY_PASSWORD, FormField.OPTIONAL);
