...
public class ScanTaskFieldModels {
    ...
    public static final StringTextFormField FIELD_FILE_PATTERN = new StringTextFormField(ScanTaskFields.FILE_PATTERNS.getParameterKey(), LABEL_FILE_PATTERN_MATCHES, DESCRIPTION_SCAN_FILE_PATTERN_MATCH, FormField.MANDATORY)
                                                                     .withInitialValue(DEFAULT_FILE_PATTERNS_MATCHES);
    public static final StringTextFormField FIELD_WORKING_DIRECTORY = new StringTextFormField(ScanTaskFields.WORKING_DIRECTORY.getParameterKey(), LABEL_WORKING_DIRECTORY, DESCRIPTION_TASK_WORKING_DIRECTORY, FormField.MANDATORY)
                                                                          .withInitialValue(DEFAULT_WORKING_DIRECTORY);
    public static final NumberTextFormField FIELD_SCAN_MEMORY = new NumberTextFormField(ScanTaskFields.SCAN_MEMORY.getParameterKey(), LABEL_SCAN_MEMORY, DESCRIPTION_SCAN_MEMORY, FormField.MANDATORY)
                                                                    .withInitialValue(DEFAULT_SCAN_MEMORY);
    public static final CheckboxFormField FIELD_ALWAYS_SCAN = new CheckboxFormField(ScanTaskFields.ALWAYS_SCAN.getParameterKey(), LABEL_ALWAYS_SCAN, DESCRIPTION_ALWAYS_SCAN, FormField.OPTIONAL);
    public static final CheckboxFormField FIELD_RESCAN_FAILURE = new CheckboxFormField(ScanTaskFields.RESCAN_FAILURES.getParameterKey(), LABEL_RESCAN_FAILURE, DESCRIPTION_RESCAN_FAILURE, FormField.OPTIONAL);
    public static final StringTextFormField FIELD_ARTIFACT_CUTOFF = new StringTextFormField(ScanTaskFields.OLD_ARTIFACT_CUTOFF.getParameterKey(), LABEL_ARTIFACT_CUTOFF, DESCRIPTION_SCAN_CUTOFF, FormField.OPTIONAL)
